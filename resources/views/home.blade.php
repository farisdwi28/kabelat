...
<body>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center gap-x-1">
                <div>
                    ...
                    <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">Meriahkan Sasakala Dongeng Bandung
                        Bersama
